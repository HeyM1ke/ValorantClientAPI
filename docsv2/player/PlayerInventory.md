# Player Inventory
Get Player's Current Inventory Loadout. (Please Refer to [ID List](https://github.com/RumbleMike/ValorantAPI/blob/master/docsv2/content/ValorantID.md) to match IDS with Skins.)
